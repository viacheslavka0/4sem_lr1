...
let C = prompt("Введите градусы в Цельсиях", 24);
F = prompt("Введите градусы в Фаренгейтах", 98.6);

console.log(`${C}\xB0C соответсвует ${(C * 9) / 5 + 32}\xB0F`);
console.log(`${F}\xB0F соответсвует ${((F - 32) * 5) / 9}\xB0C`);
...
let t1 = prompt(" Введите первое число"),
  t2 = prompt(" Введите второе число");
console.log(t1, t2);
...
let m1 = prompt(" Введите первое число"),
  m2 = prompt(" Введите второе число"),
  m3 = prompt(" Введите третье число"),
  m4 = prompt(" Введите четвертое число"),
  m5 = prompt(" Введите пятое число");
